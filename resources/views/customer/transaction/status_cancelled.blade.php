...
<div class="bg-white p-8 rounded-2xl shadow-lg text-center">
    ...
    <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 mb-6 text-left" role="alert">
      ...
      <p>Dana pesanan sebesar <strong>Rp {{ number_format($order->total_price, 0, ',', '.') }}</strong> telah berhasil dikembalikan secara otomatis ke <strong>Saldo (Balance)</strong> akun Anda.</p>
    </div>
